!function t(e, n, r) {
    ...
    1: [function (t, e, n) {
        ...
        _.each(u, function (t, e) {
            r[e] = function (e, n, r) {
                var i = this._listeningTo || (this._listeningTo = {}), o = e._listenId || (e._listenId = _.uniqueId("l"));
        ...
        !function () {
            function t(t) {
                ...
                this.getPolarAngle = function () {
                    ...
                    var r = new THREE.Vector3, l = (new THREE.Quaternion).setFromUnitVectors(t.up, new THREE.Vector3(0, 1, 0)), f = l.clone().inverse(),
                        h = new THREE.Vector3, p = new THREE.Quaternion;
                    return function () {
            ...
            var r, i, o = function (e, o) {
                    ...
                    if (y.enabled !== !1) {
                        switch (t.touches.length) {
                            ...
                            case 2:
                                if (y.enableZoom === !1) return;
                                P = O.TOUCH_DOLLY;
                                var e = t.touches[0].pageX - t.touches[1].pageX, n = t.touches[0].pageY - t.touches[1].pageY, r = Math.sqrt(e * e + n * n);
                                C.set(0, r);
                                break;
                            case 3:
                                if (y.enablePan === !1) return;
                    ...
                    if (y.enabled !== !1) {
                        ...
                        switch (t.touches.length) {
                            ...
                            case 2:
                                ...
                                var n = t.touches[0].pageX - t.touches[1].pageX, r = t.touches[0].pageY - t.touches[1].pageY, i = Math.sqrt(n * n + r * r);
              ...
              //}, this.enabled = !0, this.center = this.target, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.keyPanSpeed = 7, this.autoRotate = !1, this.autoRotateSpeed = 2, this.enableKeys = !0, this.keys = {
				}, this.enabled = !0, this.center = this.target, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !1, this.keyPanSpeed = 7, this.autoRotate = !0, this.autoRotateSpeed = 2, this.enableKeys = !0, this.keys = {
                    LEFT: 37,
                    UP: 38,
                    RIGHT: 39,
                    BOTTOM: 40
                }, this.mouseButtons = {ORBIT: THREE.MOUSE.LEFT, ZOOM: THREE.MOUSE.MIDDLE, PAN: THREE.MOUSE.RIGHT};
                var y = this, b = new THREE.Vector2, w = new THREE.Vector2, x = new THREE.Vector2, E = new THREE.Vector2, T = new THREE.Vector2, R = new THREE.Vector2,
                    C = new THREE.Vector2, M = new THREE.Vector2, S = new THREE.Vector2,
                    O = {NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_DOLLY: 4, TOUCH_PAN: 5}, P = O.NONE;
        ...
        function r(t) {
            var e = t.slice(0, 27), n = 1 / (2 * Math.sqrt(Math.PI)), r = -(.5 * Math.sqrt(3 / Math.PI)), i = -r, o = r, a = .5 * Math.sqrt(15 / Math.PI), s = -a,
                c = .25 * Math.sqrt(5 / Math.PI), u = s, l = .25 * Math.sqrt(15 / Math.PI),
        ...
        THREE.MaterialLoader.setShaders = function (t) {
            ...
            if (t.customType && "PBRMaterial" === t.customType) {
                var n = t.metalGlossMap ? this.getTexture(t.metalGlossMap) : null, s = t.map2 ? this.getTexture(t.map2) : null,
                    c = t.normalMap2 ? this.getTexture(t.normalMap2) : null, u = t.aoMap2 ? this.getTexture(t.aoMap2) : null,
                    l = t.lightMapM ? this.getTexture(t.lightMapM) : null, f = t.lightMapDir ? this.getTexture(t.lightMapDir) : null,
                    h = t.emissiveMap ? this.getTexture(t.emissiveMap) : null, p = t.packedPBRMap ? this.getTexture(t.packedPBRMap) : null;
                return r.create({
    ...
    }, {15: 15, 20: 20, 21: 21, 22: 22}], 14: [function (t, e, n) {
        ...
        var s = t("24"), c = t("29"), u = t("16"), l = t("11"), f = t("9"), h = t("12"), p = t("10"), d = new THREE.LoadingManager, v = new u(d), m = {},
            g = r(new THREE.TextureLoader(d), m), y = r(new l(1024, (!1), d), m), b = r(new f(256, (!1), d), m), w = {}, x = new h(d), E = {}, T = r(new p(d), E),
            R = {environmentPath: "assets/environments", geometryPath: "assets/scenes/data/", manager: d, sceneLoader: v}, C = "";
    ...
    }, {10: 10, 11: 11, 12: 12, 16: 16, 24: 24, 29: 29, 9: 9}], 16: [function (t, e, n) {
        var r = function (t) {
    ...
    }, {13: 13, 15: 15, 16: 16, 22: 22, 24: 24}], 18: [function (t, e, n) {
        ...
        var i = t("21"), o = t("15"), a = {normalMapFactor: "uNormalMapFactor", normalMap: "sTextureNormalMap", matcapMap: "sTextureAOMap"}, s = function (t) {
            t = Object.assign({
        ...
        var i = t("23"), o = t("15"), a = t("4"), s = {
            ...
            }, this), this.extensions = {derivatives: !0, shaderTextureLOD: null !== THREE.Extensions.get("EXT_shader_texture_lod")}, this.pbr = !0, this.lights = !0
        };
        c.inherit(i, {
            _clone: function (t) {
                var e = t || new c;
            ...
            var n = a.CreateWhiteTexture(), i = a.CreateNormalTexture(), s = t.albedoMap || n, u = t.albedoMap2 || n, l = t.normalMap || i, f = t.normalMap2 || i,
                h = t.aoMap || n, p = t.aoMap2 || n, d = t.metalGlossMap || n, v = t.emissiveMap || n, m = t.lightMap || n, g = t.lightMapDir || n,
    ...
    }, {15: 15, 23: 23, 4: 4}], 23: [function (t, e, n) {
        var r = ["side", "alphaTest", "transparent", "depthWrite", "shading", "wireframe"], i = function (t) {
                    ...
                    1: [function (t, e, n) {
                        ...
                        e.exports = function (t) {
                            ...
                            return t.prototype._promiseCreated = function () {
                                ...
                                var n = t.prototype._pushContext, o = t.prototype._popContext, a = t._peekContext, s = t.prototype._peekContext,
                        ...
                        n.exports = function (n, r) {
                            ...
                            var k, F, j, D = n._getDomain, H = n._async, N = e("./errors").Warning, I = e("./util"), U = I.canAttachTrace,
                                z = /[\\\/]bluebird[\\\/]js[\\\/](release|debug|instrumented)/, B = /\((?:timers\.js):\d+:\d+\)/, V = /[\/<\(](.+?):(\d+):(\d+)\)?\s*$/,
                                G = null, X = null, Y = !1, q = !(0 == I.env("BLUEBIRD_DEBUG")),
                            ...
                            return Z && n.longStackTraces(), {
                                longStackTraces: function () {
                                    ...
                                    return p
                                }, checkForgottenReturns: m, setBounds: L, warn: _, deprecated: g, CapturedTrace: A, fireDomEvent: Q, fireGlobalEvent: J
                            }
                        }
                        ...
                        var o, a, s = t("./es5"), c = s.freeze, u = t("./util"), l = u.inherits, f = u.notEnumerableProp, h = r("Warning", "warning"),
                            p = r("CancellationError", "cancellation error"), d = r("TimeoutError", "timeout error"), v = r("AggregateError", "aggregate error");
                        try {
                        ...
                        b || (b = c({
                            ...
                            RejectionError: i,
                            AggregateError: v
                        }), s.defineProperty(Error, "__BluebirdErrorTypes__", {value: b, writable: !1, enumerable: !1, configurable: !1})), e.exports = {
                            Error: Error,
                            TypeError: o,
                            RangeError: a,
                        ...
                        e.exports = function (e, n, r, i, o, a) {
                            ...
                            var u = t("./errors"), l = u.TypeError, f = t("./util"), h = f.errorObj, p = f.tryCatch, d = [];
                        ...
                        var a = t("./util"), s = a.maybeWrapAsError, c = t("./errors"), u = c.OperationalError, l = t("./es5"), f = /^(?:name|message|stack|cause)$/;
                        e.exports = o
                        ...
                        e.exports = function (e) {
                            ...
                            function r(t, e) {
                                var n = this, r = n._boundValue(), i = void 0 === t ? s(e).call(r, null) : s(e).call(r, null, t);
                                i === c && a.throwLater(i.e)
                            }
                        ...
                        n.exports = function () {
                            ...
                            var w = function () {
                                }, x = {}, E = {}, T = e("./thenables")(o, w), R = e("./promise_array")(o, w, T, h, r), C = e("./context")(o), M = C.create,
                                S = e("./debuggability")(o, C), O = (S.CapturedTrace, e("./finally")(o, T, E)), P = e("./catch_filter")(E), L = e("./nodeback"),
                                A = d.errorObj, k = d.tryCatch;
                        ...
                        e.exports = function (e, n) {
                            ...
                            var f, h = {}, p = t("./util"), d = t("./nodeback"), v = p.withAppended, m = p.maybeWrapAsError, g = p.canEvaluate,
                                _ = t("./errors").TypeError, y = "Async", b = {__isPromisified__: !0},
                        ...
                        e.exports = function (e, n, r) {
                            ...
                            var a = t("./util"), s = t("./errors").RangeError, c = t("./errors").AggregateError, u = a.isArray, l = {};
                        ...
                        e.exports = function (e, n, r, i, o, a) {
                            ...
                            var d = t("./util"), v = t("./errors").TypeError, m = t("./util").inherits, g = d.errorObj, _ = d.tryCatch, y = {};
                        ...
                        function d(t) {
                            try {
                                if ("function" == typeof t) {
                                    var e = S.names(t.prototype), n = S.isES5 && e.length > 1, r = e.length > 0 && !(1 === e.length && "constructor" === e[0]),
                        ...
                        var U = "undefined" != typeof t && "[object process]" === E(t).toLowerCase(), z = "undefined" != typeof t && "undefined" != typeof t.env, B = {
                            isClass: d,
                            isIdentifier: m,
                            inheritedDataKeys: F,
        ...
        (function (r, i) {
            !function (t, r) {
                ...
                var Y = X, q = 0, W = void 0, Z = void 0, $ = function (t, e) {
                    ...
                    }, K = "undefined" != typeof window ? window : void 0, Q = K || {}, J = Q.MutationObserver || Q.WebKitMutationObserver,
                    tt = "undefined" == typeof self && "undefined" != typeof r && "[object process]" === {}.toString.call(r),
                    et = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, nt = new Array(1e3),
                    rt = void 0;
                rt = tt ? s() : J ? u() : et ? l() : void 0 === K && "function" == typeof t ? p() : f();
                var it = Math.random().toString(36).substring(16), ot = void 0, at = 1, st = 2, ct = new P, ut = new P, lt = 0;
    ...
    }, {26: 26, 30: 30, 31: 31, 32: 32}], 30: [function (t, e, n) {
        function r(t) {
        ...
        (function (t) {
            (function () {
                ...
                function T(t) {
                    ...
                    function Gt() {
                        var t = this.__wrapped__.value(), e = this.__dir__, n = Os(t), r = e < 0, i = n ? t.length : 0, o = Yn(0, i, this.__views__), a = o.start,
                            s = o.end, c = s - a, u = r ? s : a - 1, l = this.__iteratees__, f = l.length, h = 0, p = Ea(c, this.__takeCount__);
                    ...
                    function fn(t) {
                        return gi(function (e, n) {
                            var r = -1, i = null == e ? 0 : n.length, o = i > 2 ? n[i - 2] : R, a = i > 2 ? n[2] : R, s = i > 1 ? n[i - 1] : R;
                    ...
                    function An(t, e, n, r, i, o, a, s, c, u) {
                        function l() {
                            ...
                            if (r && (w = cn(w, r, i)), o && (w = un(w, o, a)), d || m) {
                                ...
                                if (_ -= E.length, _ < u) {
                                    var T = s ? te(s) : R, C = xa(u - _, 0), O = d ? E : R, P = d ? R : E, L = d ? w : R, F = d ? R : w;
                    ...
                    function ir(t, e) {
                        var n = t[1], r = e[1], i = n | r, o = i < F, a = r == F && n == P || r == F && n == j && t[7].length <= e[8] || r == (F | j) && n == P;
                        if (!o && !a) return t;
                    ...
                    function yo(t, n, r) {
                        ...
                        var o, a, c = me(ge({}, n.imports), i.imports, ve), u = Us(c), l = tn(c, u), f = 0, h = n.interpolate || Ht, p = "__p += '",
                    ...
                    var zo = t.Array, Bo = t.Date, Vo = t.Error, Go = t.Function, Xo = t.Math, Yo = t.Number, qo = t.Object, Wo = t.RegExp, Zo = t.String,
                        $o = t.TypeError, Ko = zo.prototype, Qo = qo.prototype, Jo = Zo.prototype, ta = Go.prototype.toString, ea = Qo.hasOwnProperty, na = 0,
                        ra = Qo.toString, ia = ne._,
                        oa = Wo("^" + ta.call(ea).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                        aa = t.ArrayBuffer, sa = t.clearTimeout, ca = t.parseFloat, ua = Xo.pow, la = Qo.propertyIsEnumerable, fa = Xn(t, "Set"), ha = t.setTimeout,
                        pa = Ko.splice, da = t.Uint8Array, va = Xn(t, "WeakMap"), ma = Xo.ceil, ga = Xn(qo, "create"), _a = Xo.floor, ya = Xn(zo, "isArray"),
                        ba = t.isFinite, wa = Xn(qo, "keys"), xa = Xo.max, Ea = Xo.min, Ta = Xn(Bo, "now"), Ra = t.parseInt, Ca = Xo.random, Ma = Yo.NEGATIVE_INFINITY,
                        Sa = Yo.POSITIVE_INFINITY, Oa = 4294967295, Pa = Oa - 1, La = Oa >>> 1, Aa = 9007199254740991, ka = va && new va, Fa = {};
                    e.support = {};
                    ...
                    }), As = yn(Ls, de), ks = yn(Ps, or), Fs = En(Le), js = En(Ae), Ds = Cn(Na), Hs = Cn(Ia), Ns = Mn(Le), Is = Mn(Ae), Us = wa ? function (t) {
                    ...
                    return e.prototype = n.prototype, _.prototype = ja(n.prototype), _.prototype.constructor = _, K.prototype = ja(n.prototype), K.prototype.constructor = K, Xt.prototype["delete"] = Yt, Xt.prototype.get = qt, Xt.prototype.has = Wt, Xt.prototype.set = Zt, $t.prototype.push = Qt, di.Cache = Xt, e.after = li, e.ary = fi, e.assign = Ls, e.at = ns, e.before = hi, e.bind = ms, e.bindAll = gs, e.bindKey = _s, e.callback = Co, e.chain = zr, e.chunk = dr, e.compact = vr, e.constant = Mo, e.countBy = rs, e.create = Zi, e.curry = ys, e.curryRight = bs, e.debounce = pi, e.defaults = As, e.defaultsDeep = ks, e.defer = ws, e.delay = xs, e.difference = Ga, e.drop = mr, e.dropRight = gr, e.dropRightWhile = _r, e.dropWhile = yr, e.fill = br, e.filter = Kr, e.flatten = xr, e.flattenDeep = Er, e.flow = Es, e.flowRight = Ts, e.forEach = as, e.forEachRight = ss, e.forIn = Ds, e.forInRight = Hs, e.forOwn = Ns, e.forOwnRight = Is, e.functions = $i, e.groupBy = cs, e.indexBy = us, e.initial = Rr, e.intersection = qa, e.invert = Ji, e.invoke = ls, e.keys = Us, e.keysIn = to, e.map = ti, e.mapKeys = zs, e.mapValues = Bs, e.matches = Oo, e.matchesProperty = Po, e.memoize = di, e.merge = Ps, e.method = Qs, e.methodOf = Js, e.mixin = Lo, e.modArgs = Rs, e.negate = vi, e.omit = Vs, e.once = mi, e.pairs = eo, e.partial = Cs, e.partialRight = Ms, e.partition = fs, e.pick = Gs, e.pluck = ei, e.property = Fo, e.propertyOf = jo, e.pull = Sr, e.pullAt = Wa, e.range = Do, e.rearg = Ss, e.reject = ni, e.remove = Or, e.rest = Pr, e.restParam = gi, e.set = ro, e.shuffle = ii, e.slice = Lr, e.sortBy = si, e.sortByAll = ds, e.sortByOrder = ci, e.spread = _i, e.take = Ar, e.takeRight = kr, e.takeRightWhile = Fr, e.takeWhile = jr, e.tap = Br,e.throttle = yi,e.thru = Vr,e.times = Ho,e.toArray = qi,e.toPlainObject = Wi,e.transform = io,e.union = Ka,e.uniq = Dr,e.unzip = Hr,e.unzipWith = Nr,e.values = oo,e.valuesIn = ao,e.where = ui,e.without = Qa,e.wrap = bi,e.xor = Ir,e.zip = Ja,e.zipObject = Ur,e.zipWith = ts,e.backflow = Ts,e.collect = ti,e.compose = Ts,e.each = as,e.eachRight = ss,e.extend = Ls,e.iteratee = Co,e.methods = $i,e.object = Ur,e.select = Kr,e.tail = Pr,e.unique = Dr,Lo(e, e),e.add = Io,e.attempt = Ks,e.camelCase = Xs,e.capitalize = uo,e.ceil = tc,e.clone = wi,e.cloneDeep = xi,e.deburr = lo,e.endsWith = fo,e.escape = ho,e.escapeRegExp = po,e.every = $r,e.find = is,e.findIndex = Xa,e.findKey = Fs,e.findLast = os,e.findLastIndex = Ya,e.findLastKey = js,e.findWhere = Qr,e.first = wr,e.floor = ec,e.get = Ki,e.gt = Ei,e.gte = Ti,e.has = Qi,e.identity = So,e.includes = Jr,e.indexOf = Tr,e.inRange = so,e.isArguments = Ri,e.isArray = Os,e.isBoolean = Ci,e.isDate = Mi,e.isElement = Si,e.isEmpty = Oi,e.isEqual = Pi,e.isError = Li,e.isFinite = Ai,e.isFunction = ki,e.isMatch = ji,e.isNaN = Di,e.isNative = Hi,e.isNull = Ni,e.isNumber = Ii,e.isObject = Fi,e.isPlainObject = Ui,e.isRegExp = zi,e.isString = Bi,e.isTypedArray = Vi,e.isUndefined = Gi,e.kebabCase = Ys,e.last = Cr,e.lastIndexOf = Mr,e.lt = Xi,e.lte = Yi,e.max = nc,e.min = rc,e.noConflict = Ao,e.noop = ko,e.now = vs,e.pad = vo,e.padLeft = qs,e.padRight = Ws,e.parseInt = mo,e.random = co,e.reduce = hs,e.reduceRight = ps,e.repeat = go,e.result = no,e.round = ic,e.runInContext = T,e.size = oi,e.snakeCase = Zs,e.some = ai,e.sortedIndex = Za,e.sortedLastIndex = $a,e.startCase = $s,e.startsWith = _o,e.sum = Uo,e.template = yo,e.trim = bo,e.trimLeft = wo,e.trimRight = xo,e.trunc = Eo,e.unescape = To,e.uniqueId = No,e.words = Ro,e.all = $r,e.any = ai,e.contains = Jr,e.eq = Pi,e.detect = is,e.foldl = hs,e.foldr = ps,e.head = wr,e.include = Jr,e.inject = hs,
                        ...
                        K.prototype[t] = function (n) {
                            ...
                            var i = this.clone();
                            return r ? i.__takeCount__ = Ea(i.__takeCount__, n) : i.__views__.push({size: n, type: t + (i.__dir__ < 0 ? "Right" : "")}), i
                        ...
                        K.prototype[t] = function (t, e) {
                            var i = this.clone();
                            return i.__iteratees__.push({iteratee: zn(t, e, 1), type: n}), i.__filtered__ = i.__filtered__ || r, i
                        }
                        ...
                        var r = /^(?:filter|map|reject)|While$/.test(n), i = /^(?:first|last)$/.test(n), o = e[i ? "take" + ("last" == n ? "Right" : "") : n];
                        o && (e.prototype[n] = function () {
                            var e = i ? [1] : arguments, n = this.__chain__, a = this.__wrapped__, s = !!this.__actions__.length, c = a instanceof K, u = e[0],
                                l = c || Os(a);
                        ...
                        var n = (/^(?:replace|split)$/.test(t) ? Jo : Ko)[t], r = /^(?:push|sort|unshift)$/.test(t) ? "tap" : "thru",
                ...
                var R, C = "3.10.1", M = 1, S = 2, O = 4, P = 8, L = 16, A = 32, k = 64, F = 128, j = 256, D = 30, H = "...", N = 150, I = 16, U = 200, z = 1, B = 2,
                    V = "Expected a function", G = "__lodash_placeholder__", X = "[object Arguments]", Y = "[object Array]", q = "[object Boolean]",
                    W = "[object Date]", Z = "[object Error]", $ = "[object Function]", K = "[object Map]", Q = "[object Number]", J = "[object Object]",
                    tt = "[object RegExp]", et = "[object Set]", nt = "[object String]", rt = "[object WeakMap]", it = "[object ArrayBuffer]",
                    ot = "[object Float32Array]", at = "[object Float64Array]", st = "[object Int8Array]", ct = "[object Int16Array]", ut = "[object Int32Array]",
                    lt = "[object Uint8Array]", ft = "[object Uint8ClampedArray]", ht = "[object Uint16Array]", pt = "[object Uint32Array]", dt = /\b__p \+= '';/g,
                    vt = /\b(__p \+=) '' \+/g, mt = /(__e\(.*?\)|\b__t\)) \+\n'';/g, gt = /&(?:amp|lt|gt|quot|#39|#96);/g, _t = /[&<>"'`]/g, yt = RegExp(gt.source),
                    bt = RegExp(_t.source), wt = /<%-([\s\S]+?)%>/g, xt = /<%([\s\S]+?)%>/g, Et = /<%=([\s\S]+?)%>/g,
                    Tt = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/, Rt = /^\w*$/,
                    Ct = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g,
                    Mt = /^[:!,]|[\\^$.*+?()[\]{}|\/]|(^[0-9a-fA-Fnrtuvx])|([\n\r\u2028\u2029])/g, St = RegExp(Mt.source), Ot = /[\u0300-\u036f\ufe20-\ufe23]/g,
                    Pt = /\\(\\)?/g, Lt = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, At = /\w*$/, kt = /^0[xX]/, Ft = /^\[object .+?Constructor\]$/, jt = /^\d+$/,
                    Dt = /[\xc0-\xd6\xd8-\xde\xdf-\xf6\xf8-\xff]/g, Ht = /($^)/, Nt = /['\n\r\u2028\u2029\\]/g, It = function () {
                ...
                var Gt = {
                    ...
                    Yt = {"&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#39;": "'", "&#96;": "`"}, qt = {"function": !0, object: !0}, Wt = {
                        ...
                        v: "x76",
                        x: "x78"
                    }, Zt = {"\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029"}, $t = qt[typeof n] && n && !n.nodeType && n,
                    Kt = qt[typeof e] && e && !e.nodeType && e, Qt = $t && Kt && "object" == typeof t && t && t.Object && t,
                    Jt = qt[typeof self] && self && self.Object && self, te = qt[typeof window] && window && window.Object && window,
                    ee = Kt && Kt.exports === $t && $t, ne = Qt || te !== (this && this.window) && te || Jt || this, re = T();
    ...
    }, {36: 36, 37: 37, 38: 38, 39: 39, 40: 40, 41: 41, 42: 42}], 36: [function (t, e, n) {
        !function (t, e, n) {
            function r(t) {
                var e = this, n = a();
                e.next = function () {
        ...
        !function (t, e, n) {
            ...
            function o(t, e) {
                ...
                return a["double"] = function () {
                    do var t = n.next() >>> 11, e = (n.next() >>> 0) / 4294967296, r = (t + e) / (1 << 21); while (0 === r);
                    return r
        ...
        !function (n, r) {
            ...
            var f, h = this, p = 256, d = 6, v = 52, m = "random", g = r.pow(p, d), _ = r.pow(2, v), y = 2 * _, b = p - 1;
    ...
    }, {25: 25}], 43: [function (t, e, n) {
        var r = t("1"), i = (t("8"), t("50")), o = (t("45"), t("56"), t("58")), a = (t("54"), t("48")), s = t("47"), c = t("52"), u = t("57"), l = t("60"),
            f = function (t) {
        ...
        f.inherit(r, {
            start: function (t) {
                var e = t.getObjectByName("blocks").children, n = t.getObjectByName("lanes").children, o = t.getObjectByName("intersections").children,
                    l = t.getObjectByName("cars").children, f = t.getObjectByName("clouds").children;
    ...
    }, {1: 1, 45: 45, 47: 47, 48: 48, 50: 50, 52: 52, 54: 54, 56: 56, 57: 57, 58: 58, 60: 60, 8: 8}], 44: [function (t, e, n) {
        e.exports = {
        ...
        a.inherit(i, {
            addRadarHelper: function () {
                var t = new THREE.CircleGeometry(this.radarRadius, 32, 0, Math.PI / 2), e = new THREE.MeshBasicMaterial({color: 16711935}), n = new THREE.Mesh(t, e);
                ...
                var t = new THREE.Vector3, e = new THREE.Vector3, n = new THREE.Vector3, i = new THREE.Vector3, a = new THREE.Vector3;
                return function (s) {
        ...
        i.inherit(THREE.Scene, {
            _initChunks: function () {
                ...
                var n = new THREE.Object3D, i = new THREE.PlaneGeometry(r.CHUNK_SIZE, r.CHUNK_SIZE, 1, 1), o = new THREE.MeshBasicMaterial, a = new THREE.Mesh(i, o),
    ...
    }, {46: 46, 49: 49, 50: 50, 59: 59}], 49: [function (t, e, n) {
    ...
    }, {50: 50, 55: 55, 59: 59}], 50: [function (t, e, n) {
        var r = {
            FPS: !1,
            LOG_CALLS: !1,
    ...
    }, {14: 14, 15: 15, 17: 17, 18: 18, 28: 28, 3: 3, 43: 43, 44: 44, 50: 50, 51: 51}], 54: [function (t, e, n) {
        var r = t("21"), i = t("44"), o = function (t) {
            t = Object.assign({
                vertexShader: i["basic.vs"],
                fragmentShader: i["basic.fs"],
                uniforms: {diffuse: {value: new THREE.Color(16711935)}, map: {value: null}, offsetRepeat: {value: new THREE.Vector4(0, 0, 1, 1)}, opacity: {value: 1}}
    ...
    }, {21: 21, 44: 44}], 55: [function (t, e, n) {
        var r = t("50"), i = t("59"), o = r.CHUNK_SIZE * r.TABLE_SIZE, a = THREE.Math.euclideanModulo, s = function (t) {
        ...
        s.inherit(THREE.Object3D, {
            _updateTablePosition: function () {
                ...
                var t = this.tablePosition.x - this.lastTablePosition.x, e = this.tablePosition.z - this.lastTablePosition.z;
                this.lastTablePosition.copy(this.tablePosition);
                var n = Math.floor(a(this.tablePosition.x + 40, o) / r.CHUNK_SIZE), s = Math.floor(a(this.tablePosition.z + 40, o) / r.CHUNK_SIZE), c = this.parent,
